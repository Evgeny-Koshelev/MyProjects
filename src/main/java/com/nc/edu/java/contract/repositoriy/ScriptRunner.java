...
public class ScriptRunner {
    ...
    private void executeFullScript(Reader reader) {
        ...
        try {
            ...
            throw new RuntimeException(line, var6);
        }
    }
    ...
    private void executeLineByLine(Reader reader) {
        ...
        try {
            ...
            this.printlnError(line);
            throw new RuntimeException(line, var5);
        }
    }
    ...
    private void setAutoCommit() {
        try {
            ...
            throw new RuntimeException("Could not set AutoCommit to " + this.autoCommit + ". Cause: " + var2, var2);
        }
    }
